...
const cards$1 = [...document.querySelectorAll('.card')];
...
function hideOverlay() {
	...
	cards$1.forEach((el, index) => animateItem(el, 'introShow', DEF_TIMEOUT + 600 + index * 200));
}
...
const items$1 = [...document.querySelectorAll('.heading__jobs span')];
