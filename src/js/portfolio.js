...
const data = [
  {
    ...
    date: [
      ...
      dayjs("01 Apr 2024 00:00:00 GMT").format("MMM YYYY"),
    ],
    skills: ["React", "NextUI", "Effector"],
    responsibilities: [
  ...
  },
  {
    ...
    date: [
      dayjs("01 March 2024 00:00:00 GMT").format("MMM YYYY"),
      dayjs("01 Jan 2021 00:00:00 GMT").format("MMM YYYY"),
    ],
    skills: ["Redux-saga", "NEXT.js", "SCURM", "Module Federation"],
    responsibilities: [
  ...
  },
  {
    ...
    date: [
      dayjs("01 Apr 2024 00:00:00 GMT").format("MMM YYYY"),
      dayjs("01 Dec 2023 00:00:00 GMT").format("MMM YYYY"),
    ],
    skills: ["Sequelize", "Node.js", "Vue 3", "Vite"],
    responsibilities: [
  ...
  },
  {
    ...
    date: [
      dayjs("01 Jan 2021 00:00:00 GMT").format("MMM YYYY"),
      dayjs("01 Jan 2018 00:00:00 GMT").format("MMM YYYY"),
    ],
    skills: ["React", "Node.js", "Feathers", "Styled-components"],
    responsibilities: ["Разработка SPA для терминалов"],
  },
];
...
createApp({
  setup() {
    ...
    function getDiffDates(el) {
      ...
      const textMonth = `${showedMonth} ${declOfNum(showedMonth, [
        "месяц",
        "месяца",
        "месяцев",
      ])}`;
