...
button.forEach(el => el.onclick = (e) => {
...
createApp({
    setup() {
        ...
        const total = computed(() => priceUsdtKzt.value / kztThb.value * freeNKZT)
        ...
        const formattedTotal = computed(() => formattingPrice(currency.value, total.value))
